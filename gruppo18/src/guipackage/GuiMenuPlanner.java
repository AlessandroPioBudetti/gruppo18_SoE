...
public class GuiMenuPlanner extends javax.swing.JFrame {
     ...
     */
    public GuiMenuPlanner(Statement st) {
        initComponents();
        this.st = st;
    }
    ...
    private void initComponents() {
        ...
        jMenu1.setBackground(new java.awt.Color(27, 64, 82));
        jMenu1.setText("File");
        ...
        jMenu2.setBackground(new java.awt.Color(27, 64, 82));
        jMenu2.setText("Manage");

        jMenuItem2.setBackground(new java.awt.Color(141, 199, 228));
        jMenuItem2.setText("Gestione delle attività di manutenzione.");
        ...
        jMenuItem3.setText("Gestione dei materiali.");
        jMenu2.add(jMenuItem3);

        jMenuItem4.setBackground(new java.awt.Color(141, 199, 228));
        jMenuItem4.setText("Assegna un'attività.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GuiMenuPlanner.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //new GuiMenuPlanner().setVisible(true);
            }
        });
    }
